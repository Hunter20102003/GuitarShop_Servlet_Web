...
public class Pagging extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<ProductDBO> listProduct = (ArrayList<ProductDBO>) session.getAttribute("listPageProduct");
        String idPage = request.getParameter("idPage");
        session.setAttribute("listProduct", dao.pageProduct(listProduct, Integer.parseInt(idPage)));

 ...
 * @author LEGION
 */
@WebServlet(name = "Load_All_Products", urlPatterns = {"/shop"})
public class Load_All_Products extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<FeedBackDBO> list3 = dao.getAllFeedBack();
        if (!list.isEmpty()) {
        ...
        session.setAttribute("listFeedback", list3);
